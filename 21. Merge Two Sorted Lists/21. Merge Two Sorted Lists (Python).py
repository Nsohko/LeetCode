...
def linkedlistmerger1(head1,head2):
  ...
  while head1!=None and head2!=None:
    ...
    if head1==None:
      ...
      curout.next=head1
  return dummy.next 
#careful about this. Out was initialised as a dummy mode.The next node of the dummy node points to the true head value!
  
def linkedlistmerger2(head1, head2): #an alternative solution
  if head1== def recurslinkedlistmerge(head1,head2):
  if head1==None:
    return head2
  elif head2==None:
    return head1
